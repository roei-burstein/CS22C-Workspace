 ...
 * <p>
 * Description: This program is the interface for the LinkedList object.
 * <p>
 */
...
public interface ListInterface<T> {
	 ...
	 * @param newEntry
	 *            The object to be added as a new entry.
	 * @return true if newPosition is in range, false if newPosition < 1 or
	 ...
	 * 
	 * @param anEntry
	 *            The object to be removed from the list, which is "found" if equals
	 *            returns true
	 * @return true if the parameter is found and removed, false otherwise
	 * @does nothing if either givenPosition < 1 or givenPosition > getLength().
	 */
	 ...
	 * @return A reference to the removed entry, OR null if givenPosition < 1 or
	 ...
	 * @returns null if either givenPosition < 1 or givenPosition > getLength().
	 */
